		...
		init : function( options )
		{
			...
			var menuItems = { 'fonteffects': true,
						   ...
						   'insert_img'	: { "modal": true,
											...
											"onSave": function(){
												methods.restoreSelection.apply(this);				console.log($('#imageList').data('current'));
												$("#ImagenAMostrar").attr("src",$('#imageList').data('current'))		
												...
												// }
												// else{
												// 	methods.showMessage.apply(this,["imgErrMsg","Por favor seleciona una imagen"]);
												// 	return false;
												// }
						...
						'insert_table'	: { "modal": true,
						   ...
						   'outdent'	: { "text": "Outdent", 
							...
							'splchars'	: { "text": "S", 
											"icon": "fa fa-asterisk", 
											"tooltip": "Insertar Caracteres especiales", 
											"commandname":null, 
											"custom":function(button){
